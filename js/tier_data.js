...
export const perks_data={
	standard_badge:{
		...
		desc_en:"",
		desc_ko:"행사 로고와 참가자 등급이 인쇄된 내구성 좋은 PVC 재질의 목걸이형 명찰입니다."},
	daiso_badge:{
	...
	tin_badge_sponsor:{
		...
		desc_en:"",
		desc_ko:"말랑포니의 후원자임을 증명하는 한정판 핀뱃지입니다."},
	opening_closing_mention:{
	...
	stamp:{
		...
		desc_en:"",
		desc_ko:"말랑포니 운영진이 직접 디자인한 한정판 도장입니다."},
	embroidered_tag:{
	...
	song_request:{
		...
		desc_en:"",
		desc_ko:"행사의 피날레인 DJ 파티, 귀하가 선택한 음악으로 플로어를 채울 수 있습니다. DJ가 VVIP의 신청곡임을 특별히 언급하며 재생해 드립니다."},
	signed_poster:{
		name_en:"Poster Signed by Staff",name_ko:"스태프 사인 포스터",
		desc_en:"",
		desc_ko:"행사를 만들어간 모든 스태프와 게스트의 존경과 감사가 담긴 포스터입니다."},
	opening_closing_floor:{
		name_en:"",name_ko:"개·폐회식 축사 권한",
		desc_en:"",
		desc_ko:"원하실 경우, 개/폐회식에서 무대에 올라와, 참가자들에게 짧은 인사나 소감을 발표할 수 있는 시간을 드립니다."},
	tin_badge_princess:{
		name_en:"",name_ko:"로얄프린세스 전용 핀뱃지",
		desc_en:"",
		desc_ko:"말랑포니의 후원자임을 증명하는 한정판 핀뱃지입니다.",
		overwrites:["tin_badge_mane","tin_badge_sponsor"]},
	shipping:{
		name_en:"",name_ko:"배송 서비스",
		desc_en:"",
		desc_ko:"현장에서 수령한 무거운 굿즈들을 댁까지 편안하게 택배로 발송해 드립니다."},
	discord_hotline:{
		name_en:"",name_ko:"디스코드 핫라인",
		desc_en:"",
		desc_ko:"운영진과 직접 소통할 수 있는 전용 채널에 초대되며, 건의사항을 말씀해 주신다면 최우선으로 검토합니다."},
	tin_badge_spirit_dx:{
		name_en:"",name_ko:"디럭스 영혼참가 전용 핀뱃지",
		desc_en:"",
		desc_ko:"말랑포니의 후원자임을 증명하는 한정판 핀뱃지입니다."},
};
