...
// Rand.Action every: Min 5s, Max 25s, Avg 15s
// Sleep Expected at 135 seconds (2m15s)
export const OPTION_L2D_RANDOM_ACTION_MIN_INTERVAL_SECONDS=5;
export const OPTION_L2D_RANDOM_ACTION_RAND_ADD_SECONDS=20;
export const L2D_SLEEP_MINIMUM_TIME_SECONDS=60.0;
export const L2D_RANDOM_ACTION_SLEEP_TRANSITION_PROBABILITY=0.2;

export const L2D_GYRO_SENSITIVITY_X=500;
export const L2D_GYRO_SENSITIVITY_Y=500;
export const L2D_GYRO_LERP_FACTOR=3.0;
export const L2D_USE_ACCELEROMETER_INSTEAD=true;

// Lower = smoother
export const L2D_EYE_LERP_FACTOR=5.0;
...
export const OPTION_L2D_PRELOAD_MOTIONS=true;
...
export const OPTION_CASTLEBG_MIN_WIDTH_PIXELS=  200;
...
export const CREDITS_EXPANDABLE_ROLE_LIST = false;
